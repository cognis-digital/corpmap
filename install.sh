#!/usr/bin/env sh
# Universal installer for corpmap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/corpmap.git"
echo "Installing corpmap ..."
